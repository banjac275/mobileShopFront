<template>
    <div class="container flex">
      <div class="container__top flex"><h2>Phones</h2> <button class="submit" v-if="getUserCheck" @click="addPhone = !addPhone">Add phone <font-awesome-icon icon="pen" /></button></div>
      <hr>
      <div class="container__middle flex">
        <div v-for="item in recvData" :key="item._id">
          <div class="phone flex">
            ...
            <div class="phone__buttons">
              <button class="submit" @click="removePhone($event)" v-if="getUserCheck">Delete Phone</button>
              <button class="submit" @click="addToOrders($event)" v-else>Buy Phone</button>
            </div>
          </div>
        </div>
        <div class="phone flex" v-if="addPhone">
          ...
          <div class="phone__buttons">
            <button class="submit" @click="insertPhone">Add Phone <font-awesome-icon icon="pen" /></button>
